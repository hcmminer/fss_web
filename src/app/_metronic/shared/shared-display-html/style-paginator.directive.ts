...
export class StylePaginatorDirective implements OnChanges  {
  private _pageGapTxt = "...";
  ...
  private buildPageNumbers() {
    ...
    if (this._buttons.length == 0) {
      let nodeArray = [];
      if( this.vr.element.nativeElement.childNodes[0].childNodes[0]
        .childNodes[2]){
          nodeArray = this.vr.element.nativeElement.childNodes[0].childNodes[0]

...
@Component({
  selector: 'app-detail-import-increase-asset',
  templateUrl: './detail-import-increase-asset.component.html',
  styleUrls: ['./detail-import-increase-asset.component.scss']
})
export class DetailImportIncreaseAssetComponent implements OnInit {
  ...
  getDetail() {
    ...
    const subCall = this.globalService
      .globalApi(reqTar, 'get-detail-dep-increase')
      .subscribe((res) => {

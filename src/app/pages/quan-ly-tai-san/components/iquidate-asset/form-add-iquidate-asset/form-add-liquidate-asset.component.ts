...
@Component({
  selector: 'app-form-add-liquidate-asset',
  templateUrl: './form-add-liquidate-asset.component.html',
  styleUrls: ['./form-add-liquidate-asset.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class FormAddLiquidateAssetComponent implements OnInit {
  //biến
  req;
  isTransferByFile;
  item;

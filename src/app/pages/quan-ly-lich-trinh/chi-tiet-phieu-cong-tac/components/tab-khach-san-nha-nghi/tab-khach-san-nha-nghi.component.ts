...
export class TabKhachSanNhaNghiComponent implements OnInit, OnDestroy {
    ...
    loadAddForm() {
        this.addForm = this.fb.group({
            khachSan: ['', [Validators.required]],
            loaiPhong: ['', [Validators.required]],
            ghiChu: [''],
            soPhongThue: ['', [Validators.required]],
            soNgayThue: ['', [Validators.required]]
        });
    }

    changeHotel() {
        this.quanLyPhieuCongTacService.changeHotel(this.control('khachSan').value);
    }
                ...
                const requestTarget = {
                    ...
                    params: {
                        ...
                        jobHotelDTO: {
                            ...
                            hotelId: this.control('khachSan').value,
                            roomType: this.control('loaiPhong').value,
                            numberOfDay: this.control('soNgayThue').value,
                            numberOfRoom: this.control('soPhongThue').value,
